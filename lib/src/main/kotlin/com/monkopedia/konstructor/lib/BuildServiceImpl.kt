...
class BuildServiceImpl(
    ...
    override suspend fun getInfo(u: Unit): ScriptTargetInfo = ScriptTargetInfo(name, status)
    ...
    override suspend fun getBuildLength(u: Unit): Long = buildTime

    fun getStatus(): TargetStatus = status
