...
external interface `T$35` {
    var makeTree: ((children: Array<dynamic /* Tree | TreeBuffer */>, positions: Array<Number>, length: Number) -> Tree)?
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface SyntaxNode : SyntaxNodeRef {
    ...
    fun enter(pos: Number, side: String /* "-1" */, mode: IterMode = definedExternally): SyntaxNode?
...
open external class TreeCursor : SyntaxNodeRef {
    ...
    open fun moveTo(pos: Number, side: String /* "-1" */ = definedExternally): TreeCursor /* this */
