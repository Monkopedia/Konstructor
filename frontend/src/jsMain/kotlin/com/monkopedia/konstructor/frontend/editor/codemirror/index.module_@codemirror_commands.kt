...
external var invertedEffects: Facet<(tr: Transaction) -> Array<StateEffect<Any>>, Array<(tr: Transaction) -> Array<StateEffect<Any>>>>
...
external fun history(config: HistoryConfig = definedExternally): dynamic /* `T$7` | Array<dynamic /* `T$7` | Array<Extension> */> */
