...
//            useCommonJs()
    ...
    sourceSets["jsMain"].dependencies {
        implementation("com.monkopedia.ksrpc:ksrpc-ktor-client:0.7.1")
        implementation("com.monkopedia.ksrpc:ksrpc-ktor-websocket-client:0.7.1")
        ...
        implementation("org.jetbrains.kotlin-wrappers:kotlin-emotion:11.9.3-pre.360")
        implementation("org.jetbrains.kotlin-wrappers:kotlin-css:1.0.0-pre.360")
        implementation("org.jetbrains.kotlin-wrappers:kotlin-styled-next:1.2.1-pre.360")
        implementation("org.jetbrains.kotlin-wrappers:kotlin-react:18.2.0-pre.360")
        implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:18.2.0-pre.360")
        implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.3.0-pre.360")
        implementation("org.jetbrains.kotlin-wrappers:kotlin-extensions:1.0.1-pre.360")
        implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core-js:1.6.3-native-mt")
        ...
        implementation("org.jetbrains.kotlin-wrappers:kotlin-mui:5.9.1-pre.360")
        implementation("org.jetbrains.kotlin-wrappers:kotlin-mui-icons:5.8.4-pre.360")
